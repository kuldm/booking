...
# Как вариант можно вынести в conftest и назвать функцию иначе, чтобы использовать её в других тестах на уровне модуля
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (1, "2025-08-01", "2025-08-10", 2),
        (1, "2025-08-01", "2025-08-10", 3),
    ],
)
